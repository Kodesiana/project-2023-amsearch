...
python train.py --model-name ams-doc2vec --dataset-path ../data/cleaned/triplet.jsonl --output-path ../models/ams-doc2vec.gensim --epochs 100
python train.py --model-name ams-fasttext --dataset-path ../data/cleaned/triplet.jsonl --output-path ../models/ams-fasttext.gensim --epochs 100
...
python train.py --model-name ams-doc2vec-stem --dataset-path ../data/cleaned/triplet.jsonl --output-path ../models/ams-doc2vec-stem.gensim --stemming --epochs 100
python train.py --model-name ams-fasttext-stem --dataset-path ../data/cleaned/triplet.jsonl --output-path ../models/ams-fasttext-stem.gensim --stemming --epochs 100
